...
public class MercedesBenzEClass extends Car {
  ...
  private Image _image = (new ImageIcon(this.getClass().getResource("mercedesBenzEClass.gif"))).getImage();
  
  
  public MercedesBenzEClass(int x, int y, int laneWidth){
    super(x, y, LENGTH, WIDTH, laneWidth);
    _carType = "Mercedes Benz E-Class";
  }
  
  
  public MercedesBenzEClass(int x, int y, double angle, int speed, int desiredSpeed, int lane, int laneWidth){
