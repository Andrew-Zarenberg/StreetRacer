...
public class DodgeViper extends Car {
  ...
  private Image _image = (new ImageIcon(this.getClass().getResource("viper.gif"))).getImage();
  
  
  public DodgeViper(int x, int y, int laneWidth){
    super(x, y, LENGTH, WIDTH, laneWidth);
    _carType = "Dodge Viper";
  }
  
  
  public DodgeViper(int x, int y, double angle, int speed, int desiredSpeed, int lane, int laneWidth){
