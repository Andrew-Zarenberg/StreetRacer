...
public class Sierra extends Car {
  public static final int LENGTH = 89;
  public static final int WIDTH = 33;
  
  private Image _image = (new ImageIcon(this.getClass().getResource("gmcSierra.gif"))).getImage();
  
  
  public Sierra(int x, int y, int laneWidth){
    super(x, y, LENGTH, WIDTH, laneWidth);
  }
  
  
  public Sierra(int x, int y, double angle, int speed, int desiredSpeed, int lane, int laneWidth){
  ...
  public void draw(Graphics2D g2){
    ...
    // car background
    g2.drawImage(_image, x-4, y, null);
    ...
    if(_police){
      ...
      if(_sirenPhase%2 == 0){
        ...
        g2.fillRect(x+8,y,8,3);
      } else {
        g2.setColor(Color.red);
        g2.fillRect(x+16,y,8,3);
      }
