...
public class BMW3 extends Car {
  ...
  private Image _image = (new ImageIcon(this.getClass().getResource("bmw3.gif"))).getImage();
  
  
  public BMW3(int x, int y, int laneWidth){
    super(x, y, LENGTH, WIDTH, laneWidth);
    _carType = "BMW 3-Series";
  }
  
  
  public BMW3(int x, int y, double angle, int speed, int desiredSpeed, int lane, int laneWidth){
