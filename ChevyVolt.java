...
public class ChevyVolt extends Car {
  public static final int LENGTH = 80;
  public static final int WIDTH = 36;
  
  private Image _image = (new ImageIcon(this.getClass().getResource("chevyVolt.gif"))).getImage();
  
  
  public ChevyVolt(int x, int y, int laneWidth){
    super(x, y, LENGTH, WIDTH, laneWidth);
    _carType = "Chevrolet Volt";
  }
  
  
  public ChevyVolt(int x, int y, double angle, int speed, int desiredSpeed, int lane, int laneWidth){
